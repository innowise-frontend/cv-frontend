...
export const buttonStyles = tv({
  ...
  variants: {
    variant: {
      ...
      filled:
        "bg-red-4 text-white border-none shadow-button hover:!bg-red-4 disabled:bg-gray-12 disabled:border-gray-12 disabled:text-gray-6 disabled:shadow-none dark:disabled:bg-gray-19 dark:disabled:border-gray-19 dark:disabled:text-gray-29",
      outline:
