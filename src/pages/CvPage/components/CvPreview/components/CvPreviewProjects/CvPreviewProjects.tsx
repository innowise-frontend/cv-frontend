    ...
    {projects.length && (
      <div className="flex flex-col gap-10">
        {projects.map((project) => (
          <article key={project.id} className="flex min-w-0 gap-7">
            <div className="flex min-w-0 flex-1 flex-col gap-3 text-sm leading-normal">
              <h3 className="wrap-break-word text-sm font-bold uppercase tracking-wide text-red">
                {project?.name}
              </h3>
            ...
            <div className="flex min-w-0 flex-2 flex-col gap-3 text-sm">
              <div>
                ...
                <p className="wrap-break-word">
                  {formatProjectRoles(project?.roles, roleNameById)}
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="wrap-break-word">{project?.environment?.join(", ") || "—"}</p>
              </div>
            </div>
          </article>
        ))}
